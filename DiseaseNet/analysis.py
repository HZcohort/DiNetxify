...
def comorbidity_network(data:DiseaseNetworkData,
    ...
    **kwargs
    ...
    df_columns_common = ['phecode_d1','phecode_d2','name_disease_pair','N_exposed','n_total','n_with_d2/n_with_d1','n_with_d2/n_without_d1',
                         'comorbidity_network_method','describe']
    df_columns_dict = {'CN': df_columns_common+['comorbidity_beta','comorbidity_se','comorbidity_p','comorbidity_aic'],
                       'RPCN': df_columns_common+['disease_vars_list','disease_vars_zvalues','alpha','comorbidity_beta',
                                                  'comorbidity_se','comorbidity_p','comorbidity_aic'],
                       'PCN_PCA': df_columns_common+['pc_vars_list','pc_vars_zvalues','pc_sum_variance_explained',
...
def disease_trajectory(data:DiseaseNetworkData, comorbidity_strength_result:pd.DataFrame, binomial_test_result:pd.DataFrame, 
    ...
    **kwargs
    ...
    #result column names based on different method
    df_columns_common = ['phecode_d1','phecode_d2','name_disease_pair','N_exposed','n_total','n_with_d2/n_with_d1','n_with_d2/n_without_d1',
                         'trajectory_method','describe']
    df_columns_dict = {'CN': df_columns_common+['trajectory_beta','trajectory_se','trajectory_p','trajectory_aic'],
                       'RPCN': df_columns_common+['disease_vars_list','disease_vars_zvalues','alpha','trajectory_beta',
