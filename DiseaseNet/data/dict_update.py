...
#CM mapping
cm = pd.read_csv(r'C:/Users/Administrator/Desktop/data/phecode_1.2/phecode_map_cm.csv',sep='\t')
cm_9 = cm[cm['flag']==9]
...
for icd,phe in cm_9[['ICD','phecode']].values:
    try:
        ...
        cm_9_dict[icd] = [phe]
np.save(r'C:/Users/Administrator/Desktop/data/phecode_1.2/ICD-9-CM.npy',cm_9_dict)
...
for icd,phe in cm_10[['ICD','phecode']].values:
    try:
        ...
        cm_10_dict[icd] = [phe]
np.save(r'C:/Users/Administrator/Desktop/data/phecode_1.2/ICD-10-CM.npy',cm_10_dict)


#WHO mapping
who_9 = pd.read_csv(r'C:/Users/Administrator/Desktop/data/phecode_1.2/phecode_map_who_icd9.csv')
