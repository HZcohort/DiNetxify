...
class DiseaseNetworkData:
    ...
    def disease_pair(self, phewas_result:pd.DataFrame, phecode_col:str='phecode', significance_col:str='p_significance', 
        ...
        min_interval_days : int/float, default=0
            Minimum required time interval (in days) between diagnosis dates when constructing temporal D1 → D2 disease pairs.
            Disease pairs where the interval between D1 and D2 diagnoses is less than or equal to this value are considered as non-temporal disease pair.
        
        max_time_interval_days : int/float, default=np.inf
            Maximum allowed time interval (in days) between diagnosis dates when constructing temporal and non-temporal D1/D2 disease pairs.
            Disease pairs where the interval between D1 and D2 diagnoses is greater than this value are excluded.
