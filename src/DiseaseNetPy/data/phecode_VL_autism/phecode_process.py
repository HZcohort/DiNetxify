...
"""
This is a variation from the 1.3a version for a specific use case in the DiseaseNetPy project.
...
level1_info = np.load(r'src\DiseaseNetPy\data\phecode_1.3a\level1_info.npy', allow_pickle=True).item()
level1_info[313]['leaf_list'].remove(313.3)
level1_info[313]['exclude_list'] = [[312.0, 312.3],
                                    [313.0, 313.1, 313.2],
                                    [315.2, 315.0, 315.1, 315.3]]

np.save(r'src\DiseaseNetPy\data\phecode_VL_autism\level1_info.npy', level1_info)