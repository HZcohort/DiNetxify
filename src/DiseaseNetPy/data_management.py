...
class DiseaseNetworkData:
    ...
    def phenotype_data(
        ...
        column_names : dict
            ...
            Expected keys include 'Participant ID', 'Index date', 'End date', 'Exposure' (for cohort and matched cohort study), 'Sex', and 'Matching identifier' (for matched cohort study). 
            For example:
    ...
    def disease_pair(
        ...
        **kwargs
        ...
        ----------
        phewas_result : pd.DataFrame
            DataFrame containing PheWAS analysis results produced by the 'DiseaseNetPy.pheewas' function.
    ...
    def load(
        ...
        """
        Load data from a gzip-compressed pickle file and restore the attributes to this DiseaseNetPy.DiseaseNetworkData object.
    ...
    def __str__(self):
        self.__print_string = 'DiseaseNetPy.DiseaseNetworkData\n\n'
