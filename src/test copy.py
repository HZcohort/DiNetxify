...
if __name__ =="__main__":
    ...
    phewas_result.to_csv(path+"/result/phewas_result.csv")
    com_strength_result.to_csv(path+"/result/com_strength_result.csv")
    binomial_result.to_csv(path+"/result/binomial_result.csv")
    comorbidity_result.to_csv(path+"/result/comorbidity_result.csv")
    trajectory_result.to_csv(path+"/result/trajectory_result.csv")